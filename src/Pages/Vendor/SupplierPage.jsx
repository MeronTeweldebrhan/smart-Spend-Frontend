...
import SupplierTable from "../../components/Vendor/SupplierTable.jsx";
...
function SuppliersPage() {
  ...
  return (
    <div className="max-w-7xl mx-auto p-6 mt-16">
      ...
      {activeAccountId ? (
        <SupplierTable refreshKey={refreshKey} />
      ) : (
        <p className="text-red-600 font-medium bg-red-50 p-4 rounded-md">
          No active account selected. Please select an account to view suppliers.
        </p>
      )}
    </div>
  );
